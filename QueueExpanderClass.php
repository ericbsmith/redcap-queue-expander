...
namespace QueueExpanderNamespace\QueueExpanderClass;
// The next 2 lines should always be included and be the same in every module
use ExternalModules\AbstractExternalModule;
use ExternalModules\ExternalModules;
// Declare your module class, which must extend AbstractExternalModule 
class QueueExpanderClass extends AbstractExternalModule {
    ...
    // when a survey is complete the survey queue may be displayed so expand there as well
